    ...
    <div class="container">
      ...
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
        ...
        <div class="login-wrap">
          ...
          <input type="text" class="form-control" placeholder="User Name" autofocus name="email">
          <input type="password" name="password" class="form-control" placeholder="Password">
          <input type="password" name="re-password" class="form-control" placeholder="Re-type Password">
