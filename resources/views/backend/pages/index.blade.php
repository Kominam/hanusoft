            ...
            <div class="col-lg-4">
                ...
                <section class="panel">
                    <div class="panel-body">
                        ...
                        <img src="{{url('backend/img/avatar1.jpg')}}" alt="">
                        </a>
                                ...
                                <div class="timeline-desk">
                                    <div class="panel">
                                        <div class="panel-body">
                                            ...
                                            <div class="album">
                                                <a href="#">
                                                <img alt="" src="{{url('backend/img/sm-img-1.jpg')}}">
                                                </a>
                                                <a href="#">
                                                <img alt="" src="{{url('backend/img/sm-img-2.jpg')}}">
                                                </a>
                                                <a href="#">
                                                <img alt="" src="{{url('backend/img/sm-img-3.jpg')}}">
                                                </a>
                                                <a href="#">
                                                <img alt="" src="{{url('backend/img/sm-img-1.jpg')}}">
                                                </a>
                ...
                <section class="panel post-wrap pro-box">
                    ...
                    <aside class="post-highlight yellow v-align">
                        <div class="panel-body text-center">
                            <div class="pro-thumb">
                                <img src="{{url('backend/img/ring.jpg')}}" alt="">
                            </div>
                        </div>
                    </aside>
                </section>
                            ...
                            <div class="follower">
                                <div class="panel-body">
                                    ...
                                    <div class="follow-ava">
                                        <img src="{{url('backend/img/follower-avatar.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
