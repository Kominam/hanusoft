        ...
        //All Project
         ...
         View::composer(['backend.pages.create-project', 'frontend.pages.projects'], function ($view) {
          ...
          //Count unread notification
            ...
            $num_unread_noti= $cur_mem->unreadNotifications()->whereIn('type',['App\Notifications\InvitetoProject', 'App\Notifications\AddNewState','App\Notifications\UpdateState','App\Notifications\DeleteState','App\Notifications\NewResourceAdded'])->count();
